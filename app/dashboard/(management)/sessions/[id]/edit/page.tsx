...
export default function EditSessionPage() {
  ...
  if (!hasHydrated || collegesQuery.isLoading || sessionDetailQuery.isLoading) {
    return (
      <ChangingLoadingState
        messages={[
          "Loading session configuration...",
          "Syncing current candidates...",
  ...
  if (collegesQuery.error || sessionDetailQuery.error || !currentSession) {
    const message =
  ...
  return (
    <SessionBuilder
      ...
      description="Use the same guided workflow as session creation while saving candidate changes in place."
      colleges={colleges}
