...
export const Logo = ({ className }: { className?: string }) => {
  return (
    <div className={cn("flex items-center space-x-2", className)}>
      ...
      >
        <path
          d="M80 28.558L69.909 11.081L50 22.578V0H30V22.571L10.091 11.081L0 28.555L19.824 40L0 51.445L10.091 68.919L30 57.425V80H50V57.422L69.912 68.919L80 51.442L60.183 40L80 28.558Z"
          fill="currentColor"
        />
      </svg>
      <span className="text-lg font-semibold text-foreground">Univote</span>
    </div>
  );
};
